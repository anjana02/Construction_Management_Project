...
public class ManagerGui implements ActionListener{
	...
	public ManagerGui(String username){
		...
		project1.setForeground(Color.DARK_GRAY);
		...
		projectid1.setForeground(Color.BLACK);
		...
		assignTo.setForeground(Color.BLACK);
		...
		assigneProject.setForeground(Color.BLACK);
		...
		project2.setForeground(Color.DARK_GRAY);
		...
		projectid2.setForeground(Color.BLACK);
		...
		UpdateProject.setForeground(Color.BLACK);
		...
		project3.setForeground(Color.DARK_GRAY);
		...
		allocateTo.setForeground(Color.BLACK);
		...
		siteid.setForeground(Color.DARK_GRAY);
		...
		projectid3.setForeground(Color.BLACK);
		...
		builderid.setForeground(Color.BLACK);
		...
		trackBuilder.setForeground(Color.BLACK);
