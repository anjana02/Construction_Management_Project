...
/*DROP Table Client;
SELECT * from Client WHERE passcode=crypt('anjana123',passcode);
SELECT * FROM client;*/

insert into Client values('C1','Anjana','Suresh','Abids','Pathanamthitta','Kerala',689645,crypt('anjana123',gen_salt('bf',4))),
					     ('C2','Amal','Vinod','Fathimapuram','Alapuzha','kerala',688002,crypt('amal123',gen_salt('bf',4))),
					     ('C3','Anagha','Manoj','Amritapuri','kollam','Kerala',690525,crypt('anagha123',gen_salt('bf',4))),
					     ('C4','Emeric','Alex','Ranganathan Gardens','Alapuzha','kerala',600040,crypt('emeric123',gen_salt('bf',4))),
					     ('C5','Anjali','Prasanth','Sangapuramukk','Kollam','Kerala',690544,crypt('anjali123',gen_salt('bf',4)));
...
insert into Builder values  ('B1','Architect','Amal','Vinod',
						   ...
						   60000.00,'B5','sarangkrishna@gmail.com',9595959505,crypt('Sarang123',gen_salt('bf',4))),
						   
						   ('B6','Builder','Adithya','Santhosh',
						   'Abids','Kottayam','Kerala',688002,'M',
						   120000.00,'B5','adithyasanthosh@gmail.com',9595959506,crypt('Adithya123',gen_salt('bf',4))),
						   
						   ('B7','Architect','Alekhya','S',
						   'Abids','Vagamon','Kerala',688089,'F',
						   85000.00,'B5','alekhyas@gmail.com',9595959507,crypt('Alekhya123',gen_salt('bf',4))),
						   
						   ('B8','Civil Engr','Priya','Nair',
						   'Abids','Thallasery','Kerala',681232,'F',
						   45000.00,'B5','priyanair@gmail.com',9595959508,crypt('Priya123',gen_salt('bf',4))),
						   
						   ('B9','Builder','Rohit','NS',
						   'Abids','Kottayam','Kerala',688002,'M',
						   110000.00,'B9','rohotns@gmail.com',9595959509,crypt('Rohit123',gen_salt('bf',4))),
						   
						   ('B10','Architect','Vishnu','688012',
						   'Abids','Varkala','Kerala',500001,'M',
						   80000.00,'B9','vishnuvikraman@gmail.com',9595959510,crypt('Vishnu123',gen_salt('bf',4))),
						   
						   ('B11','Civil Engr','Sakshi','C',
						   'Abids','Trissur','Telangana',688005,'F',
						   65000.00,'B9','sakshic@gmail.com',9595959511,crypt('Sakshi123',gen_salt('bf',4))),
						   
						   ('B12','Builder','Pranav','Nair',
						   'Abids','Kottayam','Kerala',688002,'M',
						   100000.00,'B9','pranavnair@gmail.com',9595959512,crypt('Pranav123',gen_salt('bf',4)));
...
insert into Client_Emails values('C1','anjanasuresh@gmail.com'),
								('C2','amalvinod@gmail.com'),
								('C3','anaghamanoj@gmail.com'),
								('C4','emericcalex@gmail.com'),
								('C5','anjaliprasanth@gmail.com');
